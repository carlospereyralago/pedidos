...
class CompaniesForm extends HTMLElement {
 ...
 <!--   INICIO CAMPO NOMBRE FISCAL  -->
                  <div class="form-element">
                    <div class="form-element-label">
                      <label for="nombre-fiscal">Nombre Fiscal</label>                
                    </div>
                    <div class="form-element-input">
                      <input type="text" name="fiscalName">
                    </div>
                  </div>
<!--   FIN CAMPO NOMBRE FISCAL  -->
<!--   INICIO CAMPO Dirección Comercial  -->
                  <div class="form-element">
                    <div class="form-element-label">
                      <label for="direccion-comercial">Dirección Comercial</label>                
                    </div>
                    <div class="form-element-input">
                  ...
                  <div class="form-element">
                  <div class="form-element-label">
                    <label for="direccion-comercial">Dirección Fiscal</label>                
                  </div>
                  <div class="form-element-input">
                    <input type="text" name="fiscalAddress">
                  </div>
                </div>
<!--   FIN CAMPO Dirección Comercial  -->
<!--   INICIO CAMPO Dirección Comercial  -->
                  <div class="form-element">
                    <div class="form-element-label">
